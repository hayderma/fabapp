...
if (isset($_POST['ticket_num'])) {
        ...
        $email = $co->get_email($tick); 
         $encrypted_email =  $cr->_crypt( $email, 'e' );
        //$q_id = $co->get_q_id($ticket);
        $cancel_link= "http://localhost/queue/Unsubscribe.php?email=".$encrypted_email;
        ...
        $msg = "Sir/Mam: \r\n \r\nThe Service which you have signed up for is now available for use,"
                ...
                . "Your Ticket Number is: ".$tick." \r\n \r\nIf you would like to cancel your ticket for any reason, click"
                . " on the link below to be removed from the waiting list:\r\n".$cancel_link."\r\n \r\n UTA FabLab Queue System";
